...
# reshape input data - this is necessary in convolutional process because of how it be.  Convolution of a 2D image requires 3D input, a 3D shape would require 4D input, etc.
